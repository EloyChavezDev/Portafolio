...
export default async function BlogsPage() {
	const views = (
		await redis.mget<number[]>(
			...allBlogs.map((p) => ["pageviews", "blogs", b.slug].join(":")),
		)
	).reduce((acc, v, i) => {
			...
			<div className="px-6 pt-16 mx-auto space-y-8 max-w-7xl lg:px-8 md:space-y-16 md:pt-24 lg:pt-32">
				<div className="max-w-2xl mx-auto lg:mx-0">
					...
					<p className="mt-4 text-zinc-400">
						I share with you some of my projects completed during my learning journey, as well as those done for hobbies and freelance work, made with love from Mexico 🇲🇽
					</p>
				</div>
